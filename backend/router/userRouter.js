...
import {upload,createprofile,getProfile,updateprofile}from "../controller/profileController.js";
...
userRouter.post("/createprofile",upload.single("profile"),createprofile)
